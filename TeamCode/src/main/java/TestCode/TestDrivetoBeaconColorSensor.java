...
@Autonomous(name="TestDrive2Beacon", group="TestOnly")
//@Disabled
public class TestDrivetoBeaconColorSensor extends LinearOpMode {
    ...
    public static final byte COLOR_SENSOR_ORIGINAL_ADDRESS = 0x70;
