...
@Autonomous(name="Blue Beacon: Auto Drive", group="5954")
//@Disabled
public class LightbotBlueAutoDriveByGyro_Linear extends LightningAutonomousBaseOpmode{
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        gyroDrive(DRIVE_SPEED, 44+12, 0.0);  // Drive FWD
        Thread.sleep(750);
...
//TODO: Restore the code below if the LightningAutonomousBaseOpmode Class does not work
